...
2. Confirm the main branch is green and create an annotated SemVer tag, for
   example `git tag -a v0.3.0 -m "v0.3.0"`.
...
The current hardened pre-v1 baseline is `v0.3.0`. New backward-compatible fixes
use `v0.3.x`; intentional pre-v1 API changes require the next minor version.
